  ...
  const blogPosts = [
    {
      ...
      excerpt: "Real-world case study: How local restaurants in Nova Scotia increased bookings by 40% and reduced admin time by 60% using AI voice agents and workflow automation.",
