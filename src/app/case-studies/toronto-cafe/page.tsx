...
export default function TorontoCafeCaseStudy() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 py-16">
        ...
        >
          <h1 className="text-4xl md:text-5xl font-extrabold text-white mb-6 font-heading">
            Toronto Café Captures More Orders
          </h1>
          ...
          <div className="bg-neutral-800/80 rounded-2xl p-8 border border-neutral-700 mb-8">
            ...
            <p className="text-neutral-400">
              Downtown Coffee Co. in Toronto, Ontario, implemented Auralix AI to capture orders during busy morning rushes.
            </p>
          </div>
