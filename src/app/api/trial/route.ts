        ...
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
          <div style="background: linear-gradient(135deg, #0a0a0a, #1a1a1a); padding: 30px; border-radius: 10px; color: white;">
            ...
            <p style="font-size: 16px; margin-bottom: 20px;">
              Thank you for requesting your free trial! We're excited to help you automate your restaurant operations and never miss another call.
            </p>
            
            <div style="background: #1a1a1a; padding: 20px; border-radius: 8px; margin: 20px 0;">
              <h3 style="color: #22d3ee; margin-bottom: 15px;">Your Trial Details:</h3>
              <ul style="list-style: none; padding: 0;">
                <li style="margin-bottom: 8px;"><strong>Restaurant:</strong> ${businessName}</li>
