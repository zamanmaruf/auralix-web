...
export default function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>Auralix AI | AI Solutions for Every Industry</title>
        <meta name="description" content="Revolutionizing local businesses with automation, analytics, and smart design. Get a free consultation for your business today!" />
      </Head>
