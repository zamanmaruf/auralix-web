    ...
    <div className="min-h-screen bg-gradient-to-b from-neutral-900 via-neutral-800 to-neutral-900 text-white">
      <section className="py-16 sm:py-20 px-4">
        <div className="max-w-6xl mx-auto text-center">
          ...
          >
            Never miss another plumbing emergency. Auralix answers every call, books service appointments, and captures leads 24/7.
          </motion.p>
                ...
                onClick={() => {
                  if (typeof window !== 'undefined' && (window as any).gtag) {
                    (window as any).gtag('event', 'calendly_click', {
                      ...
                      event_label: 'Plumbing Hero',
                      location: 'plumbing_hero',
                    });
                  }
                }}
            ...
            <a
              ...
              onClick={() => {
                if (typeof window !== 'undefined' && (window as any).gtag) {
                  (window as any).gtag('event', 'calendly_click', {
                    event_category: 'conversion',
                    event_label: 'Plumbing CTA',
                    location: 'plumbing_cta',
                  });
                }
              }}
      ...
      <section className="py-16 px-4 bg-neutral-800/50">
        <div className="max-w-4xl mx-auto">
          ...
          >
            <h2 className="text-2xl font-bold text-white mb-4 font-heading">The Plumbing Call Problem</h2>
            <p className="text-neutral-300 mb-4">
              Plumbing emergencies don't wait for business hours. When pipes burst or drains back up, customers need immediate help. 
              But if no one answers, they call your competitor.
            </p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-16 px-4">
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            <p className="text-lg text-neutral-300">Addressing the top concerns plumbing businesses have about AI receptionists</p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            >
              ...
              <p className="text-neutral-300 text-sm mb-4">
                Every missed plumbing call is a lost job worth $200-$800+. If you're missing just 10 calls per month, 
                that's $2,000-$8,000 in lost revenue. Our plans start at $399/month—less than the cost of one missed emergency call.
              </p>
            ...
            <motion.div
              ...
              className="bg-neutral-800/80 backdrop-blur-sm rounded-xl p-6 border border-neutral-700"
            >
              <h3 className="text-xl font-bold text-white mb-3 font-heading">2. Will AI handle plumbing calls well?</h3>
              <p className="text-neutral-300 text-sm mb-4">
                Our AI is specifically trained on thousands of plumbing call scenarios—from burst pipe emergencies to 
                quote requests. It understands urgency, qualifies leads, and books jobs just like a seasoned dispatcher.
              </p>
              <p className="text-primary-400 text-sm font-semibold">
      ...
      <section className="py-16 px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            <h2 className="text-3xl font-bold text-white mb-6 font-heading">Ready to Stop Losing Plumbing Calls?</h2>
            <button
              onClick={() => {
                if ((window as any).triggerVapiCall) {
                  (window as any).triggerVapiCall();
