    ...
    <div className="min-h-screen bg-gradient-to-b from-neutral-900 via-neutral-800 to-neutral-900 text-white">
      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        >
          ...
          <p className="text-xl text-neutral-300">Experience the power of AI automation for your home services business with professional setup</p>
        </motion.div>
        ...
        <AnimatePresence mode="wait">
          ...
          {currentStep === 1 && (
            ...
            >
              <h2 className="text-2xl font-bold text-white mb-6 font-heading">Tell us about your business</h2>
                ...
                {[
                  {
                    ...
                    description: 'Access to all home services AI features for 14 days'
                  },
                  {
                    icon: Headphones,
                  ...
                  },
                  {
                    ...
                    description: 'Free 30-minute setup call with our home services AI specialists'
                  }
                ].map((feature, index) => (
                  <motion.div
                    key={index}
